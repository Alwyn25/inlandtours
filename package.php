...
<section class="packages" id="international">

   <h1 class="heading-title">International Destinations</h1>
...
<section class="packages" id="domestic">

   <h1 class="heading-title">Domestic Destinations</h1>
